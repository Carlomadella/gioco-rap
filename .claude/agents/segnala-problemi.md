...
gioco e le annoti in `documentazione/problemi-riscontrati.md`. Chi legge quel file è Carletto,
...
L'unico file che scrivi è `documentazione/problemi-riscontrati.md`. Se una cosa è rotta e la sistemeresti
