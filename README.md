...
| [`backend/`](backend/README.md) | il server: classifica, account, salvataggi in cloud. Node + SQLite (o PostgreSQL con `ADF_PG`), tre dipendenze: `pg`, `jose` (i token di Apple e Google), `zod` (la forma dei corpi delle rotte), vedi [`dipendenze.md`](documentazione/dipendenze.md) | `npm start` |
...
| --- | --- | --- | --- |
| ![provincia](frontend/concept/schermata_di_gioco_città_iniziale.png) | **Città di provincia** — il nome lo scrive il giocatore _(fatta)_ | si parte da qui | studio, beat maker, vita quotidiana, attività criminali |
| ![Milano](frontend/concept/schermata_di_gioco_città_di_mezzo.png) | **Milano** | livello ≥ 10, fama ≥ 50, hype ≥ 40 | studi di registrazione, manager, club, concerti, sponsor, business, shop, criminalità grossa |
| ![Los Angeles](frontend/concept/schermata_di_gioco_città_finale.png) | **Los Angeles** | livello ≥ 30, fama ≥ 90, hype ≥ 85, reputazione ≥ 80 | studi top tier, label & A&R, eventi VIP, sponsor HQ, casinò, shop luxury, business district |
