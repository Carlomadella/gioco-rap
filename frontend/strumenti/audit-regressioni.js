...
test("il server di sviluppo non sorveglia le cartelle dei dati",
  leggi("strumenti/dev.js").includes("data" + String.fromCharCode(91)) &&
  leggi("strumenti/dev.js").includes("vendor" + String.fromCharCode(91)) &&
  leggi("strumenti/dev.js").includes("if(!PLAYWRIGHT) fs.watch"));
...
(function(){
  ...
  test("una riga di pezzo senza seed esce senza data-spingi, non come bottone che non fa niente",
    ...
    /function telSpingi\(seed\)\{\r?\n\s*if\(!Number\.isFinite\(seed\) \|\| typeof studioDati !== "function"\) return;/.test(tel) &&
  ...
  test("nell'Agenda la riga piccola delle mosse e degli eventi va a capo fino a tre righe, non i puntini",
    /\.tli\[data-azione\] \.tlitx i,\.tli\[data-evento\] \.tlitx i\{white-space:normal;display:-webkit-box;\s*-webkit-box-orient:vertical;-webkit-line-clamp:3/.test(telCss));
})();
