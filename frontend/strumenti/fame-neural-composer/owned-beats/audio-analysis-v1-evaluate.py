...
VERSION = 1
EVALUATOR_VERSION = "audio-analysis-v1-evaluator-v1"
...
CONTRACT_SCHEMA = "fame-owned-beats-audio-analysis-evaluation-implementation-v1"

DEVELOPMENT_SPLIT = "development"
HOLDOUT_SPLIT = "evaluation-holdout"
DEFAULT_REVIEW_ID = "audio-analysis-v2-dev-reference-precision-v2"
DEFAULT_RUN_ID = "v1-baseline-development-001"

HERE = Path(__file__).resolve().parent
BASELINE_FILE = HERE / "audio-analysis.py"
PROTOCOL_FILE = HERE / "audio-analysis-v2-protocol.json"
CONTRACT_FILE = HERE / "audio-analysis-evaluation-implementation-v1.json"
