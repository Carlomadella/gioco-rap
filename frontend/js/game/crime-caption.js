/* Didascalie dinamiche della schermata crime.
   ...
   **Perché sono scritte in casa.** Qui dentro c'erano 118 citazioni
   testuali di pezzi rap veri, con autore e titolo: liriche protette, messe
   in un gioco che va sugli store a pagamento. Una frase di una canzone non
   diventa libera perché è corta e perché citi chi l'ha scritta, e quella
   era la strada più corta per una segnalazione a Steam e per doverle
   togliere di corsa il giorno dell'uscita. Quindi sono uscite tutte.

   Al loro posto ci sono modi di dire del mondo del gioco: nostri, scritti
   per la provincia di Anni di Fame, senza nessun autore vero da citare.
   La firma sotto non è più un artista con un disco, è il posto da cui la
   frase arriva: il muro del sottopasso, il vecchio del bar, uno appena
   uscito. Non è un ripiego. Una frase che il quartiere si passa da solo
   sta nella schermata della strada meglio di una barra americana famosa.
   ...
   sotto, guardando come sta andando il giro). Sono 64: il filtro tiene
   fuori le ultime 28 uscite, quindi la scelta resta larga. */
"use strict";
(function(){
  const CAPTIONS = [
    ...
    {id:"c012", q:"Chi ti guarda dal balcone non ti sta salutando.", da:"in cortile", tags:["heat", "city", "danger"]},
    ...
    {id:"c023", q:"L'avvocato costa. Costa meno di un silenzio sbagliato.", da:"quello del banco dei pegni", tags:["law", "arrest", "money"]},
    {id:"c024", q:"Il primo precedente è una riga. Il secondo è una storia.", da:"un vecchio del bar", tags:["precedents", "law"]},
    {id:"c025", q:"Dentro il tempo non passa: si accumula.", da:"uno appena uscito", tags:["arrest", "base"]},
    {id:"c026", q:"In cella impari due cose: aspettare e ascoltare.", da:"uno appena uscito", tags:["arrest", "base"]},
    {id:"c027", q:"Chi è uscito cambiato lo dice. Chi è cambiato si vede.", da:"in cortile", tags:["arrest", "rep"]},
    {id:"c028", q:"La firma su un verbale pesa più di una strofa.", da:"la voce del giro", tags:["law", "arrest", "precedents"]},
    {id:"c029", q:"Non ti condannano per quello che hai fatto, ma per quello che riescono a scrivere.", da:"un vecchio del bar", tags:["law", "danger", "precedents"]},
    ...
    {id:"c032", q:"Chi comanda davvero non alza mai la voce.", da:"un vecchio del bar", tags:["power", "organization"]},
    {id:"c033", q:"In alto si sta stretti: c'è posto per uno e ci provano in dieci.", da:"detto in sala prove", tags:["power", "empire", "rep"]},
    {id:"c034", q:"Ti chiamano capo il giorno che non puoi più sbagliare.", da:"la voce del giro", tags:["power", "organization", "empire"]},
    ...
    {id:"c037", q:"Le città grandi non ti aspettano. Ti superano.", da:"detto in sala prove", tags:["city", "rep"]},
    {id:"c038", q:"Sotto il cavalcavia si prova meglio che in sala: non bussa nessuno.", da:"scritto nel sottopasso", tags:["city", "base", "night"]},
    ...
    {id:"c045", q:"L'orologio si vede da lontano. Anche da chi non volevi.", da:"quello del banco dei pegni", tags:["luxury", "money", "heat"]},
    ...
    {id:"c048", q:"Di notte i conti tornano tutti. La mattina no.", da:"tuo cugino", tags:["night", "money", "danger"]},
    ...
    {id:"c053", q:"Nel piano il problema non è come entri: è come esci.", da:"la voce del giro", tags:["heist", "organization", "danger"]},
    ...
    {id:"c056", q:"Chi ha fretta paga sempre il prezzo pieno.", da:"un vecchio del bar", tags:["base", "danger", "money"]},
    ...
    {id:"c059", q:"La strada insegna in fretta, e ripete solo a chi paga.", da:"la voce del giro", tags:["base", "danger", "city"]},
