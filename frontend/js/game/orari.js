...
(function(){
  ...
  function injectCss(){
    ...
    s.textContent = `
      ...
      /* Un posto chiuso non si disegna diverso sulla foto: la sagoma non si
         vede mai (hub.css). Lo dicono il pallino, piu' spento, e la riga
         rossa dentro alla targhetta. */
