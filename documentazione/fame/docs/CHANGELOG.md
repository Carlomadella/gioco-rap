...
- approcci scartati;
- stato V0.8;
- Trap Genre Identity iniziale;
- timing 960 PPQ;
- regole hi-hat Trap;
- pitch automation hats;
- sound library corrente;
- regression tests;
...
- FASE 5 Intent Engine;
- FASE 6 Studio / Partial Regeneration;
- FASE 7 integrazione in Anni di Fame.

Regola introdotta: una fase principale aperta alla volta.
...
- focus iniziale: struttura e fraseggio.