...
| Source Separation pilot | **TECHNICAL QA PASS / HUMAN REVIEW PENDENTE** | inferenza 8/8 completata; technical QA read-only `ALL_8_FAMILIES_PASS`, 8/8 record e 32/32 stem verificati; metriche registrate senza hard threshold post-hoc; final holdout/batch131/training ancora esclusi; prossimo gate = review umana congelata drums+bass |
