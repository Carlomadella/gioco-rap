...
| Source Separation pilot | **RECEIPT CHECK PASS / INFERENZA AUTORIZZATA SUL SOLO DEVELOPMENT** | receipt `source-separation-development-inference-v1-001` verificato read-only: `AUTHORIZED_NO_INFERENCE`, 8/8 record, source family bloccate, final holdout escluso, batch 131 e training vietati; nessun output stem ancora creato; prossimo passo = esecuzione append-only HTDemucs sulle 8 family development |
