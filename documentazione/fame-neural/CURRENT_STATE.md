...
| Source Separation pilot | **INFERENZA 8/8 COMPLETA / QA PENDENTE** | HTDemucs eseguito append-only sulle sole 8 family development congelate; `INFERENCE_COMPLETE_AWAITING_TECHNICAL_AND_HUMAN_QA`, `technicalValidationPassed=true`, final holdout non acceduto, batch 131 non eseguito, training non autorizzato; prossimo gate = technical QA read-only + human review congelata su drums/bass |
