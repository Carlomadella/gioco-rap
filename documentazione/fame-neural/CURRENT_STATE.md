...
| Source Separation pilot | **RUN PREPARATO / BACKEND STANDALONE IN APERTURA** | preflight 8/8 development PASS; `source-separation-pilot-v1-001` con source SHA verificati; Audacity scripting escluso perché Music Separation non espone i parametri 4-stem; stesso modello OpenVINO congelato mantenuto; final holdout escluso |
