...
| Source Separation pilot | **ENV STANDALONE DA MATERIALIZZARE** | run 8/8 development già preparato; Python globale 3.10.11 + FFmpeg OK, Torch/OpenVINO assenti; bootstrap dedicato pin `torch 2.4.1+cpu` + `openvino 2024.6.0`; prossimo gate = creare venv, catturare freeze esatto e committare lock prima dell'inferenza |
