...
**FATTO (13–14/09/2026)** — sei ritocchi sul foglio «LUOGO: STUDIO» di Carletto: le
...
`anteprima`, al massimo tre, che all'uscita diventano spinta). Restano aperti, sullo
stesso foglio: i feat che non si scelgono, e il percorso guidato Beat → Testo → Cabina.
